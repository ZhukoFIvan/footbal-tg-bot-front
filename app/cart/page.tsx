...
import { useCreatePaymentMutation } from "@/app/store/api/paymentsApi";
...
export default function CartPage() {
  ...
  const handleProviderSelect = async (
    ...
    try {
      ...
      router.push(`/payments/failed?error=${encodeURIComponent(errorMsg)}`);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="container mx-auto px-4 py-6">
        ...
        >
          {paymentLoading ? "Создание платежа..." : "Перейти к оформлению"}
        </Button>
      </div>
